...
function activate(context) {
    let disposable = vscode.commands.registerCommand('deepseek-cline.generatePage', () => __awaiter(this, void 0, void 0, function* () {
        const pageName = yield vscode.window.showInputBox({
            prompt: 'Enter the name of the page module to generate',
            placeHolder: 'e.g. UserProfilePage'
        });
        if (pageName) {
            try {
                const result = yield (0, generator_1.generatePageModule)(pageName);
